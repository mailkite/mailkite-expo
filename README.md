...
<h1 align="center">@mailkite/expo</h1>
...
<p align="center">
  ...
  <br>The official <a href="https://mailkite.dev">MailKite</a> library for the browser & React Native.
</p>
...
<p align="center"><a href="https://www.npmjs.com/package/@mailkite/expo"><img src="https://img.shields.io/npm/v/@mailkite/expo?color=2563eb&label=npm" alt="npm"></a></p>
...
await mk.login();                         // system browser + secure token storage
...
| --- | --- |
| [`examples/01-login-and-send.tsx`](examples/01-login-and-send.tsx) | Sign the end user into THEIR OWN MailKite account (system browser + secure token… |
...
| @mailkite/expo **(this repo)** | [`mailkite-expo`](https://github.com/mailkite/mailkite-expo) | npm |
